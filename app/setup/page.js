                ...
                <div className="container mx-auto px-6">
                    <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-10 py-12'>
                        ...
                        <div className="text-center">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=14435381087&text=Olá!%20Estou%20interessado%20em%20contratar%20o%20serviço%20de%20montagem%20de%20mesa%20posta.%0AHi!%20I'm%20interested%20in%20hiring%20the%20table%20setting%20service." className="bg-customgold text-white px-4 py-2 rounded hover:bg-customrose transition-all duration-300" target='_blank'>
                                {t("assembly-button")}
                            </a>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">
                                {t("assembly-personalized-service-desc")}
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">{t("assembly-elegant-environments")}</h3>
                            <p className="text-gray-600">
                                {t("assembly-elegant-environments-desc")}
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">{t("assembly-color-palettes")}</h3>
                            <p className="text-gray-600">
                                {t("assembly-color-palettes-desc")}
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">{t("assembly-exclusive-experience")}</h3>
                            <p className="text-gray-600">
                                {t("assembly-exclusive-experience-desc")}
                            </p>
                        </div>
                    </div>
                </div>

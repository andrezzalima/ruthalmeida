                    ...
                    <div className='flex justify-center items-center gap-32 mb-10 py-12'>
                        <div>
                            <h2 className={`text-3xl font-bold text-customblue mb-6 text-center ${playfairDisplay.className}`}>
                                Montagem de Mesa Posta para Momentos Inesquecíveis
                            </h2>

                            <p className="text-lg text-center text-gray-700 mb-10 max-w-2xl mx-auto">
                                Ruth Almeida pode montar uma mesa posta diretamente na sua casa, transformando qualquer refeição em uma experiência memorável. Com sua habilidade e atenção aos detalhes, ela cria ambientes elegantes e acolhedores para qualquer ocasião.
                            </p>
                        </div>

                        <div className="flex justify-center items-center">
                            <Image
                                src="/images/montagem.png"
                                alt="Montagem de Mesa Posta"
                                width={200}
                                height={200}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">
                                Personalizamos a montagem para cada ocasião, criando elegância e estilo para momentos únicos.
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">Ambientes Elegantes</h3>
                            <p className="text-gray-600">
                                Cada detalhe da mesa posta é pensado para transformar a refeição em uma celebração inesquecível.
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">Paletas de Cores Variadas</h3>
                            <p className="text-gray-600">
                                Escolha entre uma diversidade de paletas de cores e temas para combinar perfeitamente com seu evento.
                            </p>
                        </div>

                        <div className="bg-customwhite p-6 rounded-lg shadow-lg hover:shadow-custom transition-shadow duration-300">
                            <h3 className="text-xl font-semibold text-customgold mb-4">Experiência Exclusiva</h3>
                            <p className="text-gray-600">
                                A montagem de mesa posta da Ruth oferece uma experiência exclusiva, pensada nos mínimos detalhes para surpreender seus convidados.
                            </p>
                        </div>
                    </div>
                </div>
